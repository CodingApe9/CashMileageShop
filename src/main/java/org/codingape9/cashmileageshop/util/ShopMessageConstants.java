...
public enum ShopMessageConstants {
    ...
    FAIL_INSERT_SHOP("상점을 생성하는데 실패했습니다. 상점 이름:"),
    FAIL_OPEN_SHOP("상점을 오픈하는데 실패했습니다. 상점 이름: "),
    FAIL_DELETE_SHOP("상점을 삭제하는데 실패했습니다. 상점 이름: "),
    ...
    FAIL_CLOSE_SHOP("상점을 닫는데 실패했습니다. 상점 이름: ");
